...
void setup() {
  ...
  servo2.write(95);   // Left ankle
  servo7.write(117);  // Right hip
  servo3.write(105);  // Right ankle
  servo6.write(30);   // Right knee
  servo4.write(65);   // Left knee

  delay(1100); // Let robot settle

  // === STEP 1: Tilt both ankles smoothly ===
  smoothMove(servo2, 95, 105, 15);  // Left ankle: toe up slowly
  smoothMove(servo3, 105, 85, 15);  // Right ankle: toe down slowly
}
